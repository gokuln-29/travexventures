                            ...
                            <ul className="flex flex-col gap-8">
                                <li className="flex items-start gap-6 group">
                                    ...
                                    <div className="flex flex-col pt-1">
                                        ...
                                        <a href="https://wa.me/919500125257?text=Hi%2C%20I'd%20like%20to%20plan%20a%20trip%20with%20Travex%20Ventures!" target="_blank" rel="noopener noreferrer" className="font-serif text-[22px] text-brand-gold hover:text-brand-gold-light transition-colors">
                                            +91 95001 25257
                                        </a>
                                    </div>
                                </li>
                                <li className="flex items-start gap-6 group">
                                    ...
                                    <div className="flex flex-col pt-1">
                                        <span className="font-accent text-[9px] uppercase tracking-[0.3em] text-brand-muted mb-1">WhatsApp Chat</span>
                                        <a href="https://wa.me/919047033448?text=Hi%2C%20I'd%20like%20to%20plan%20a%20trip%20with%20Travex%20Ventures!" target="_blank" rel="noopener noreferrer" className="font-serif text-[22px] text-brand-gold hover:text-brand-gold-light transition-colors">
                                            +91 90470 33448
                                        </a>
                                    </div>
                                </li>
                                <li className="flex items-start gap-6 group">
                                    ...
                                    <div className="flex flex-col pt-1">
                                        ...
                                        <a href="mailto:reservations@travexventures.com" className="font-serif text-[22px] text-brand-gold hover:text-brand-gold-light transition-colors">
                                            reservations@travexventures.com
                                        </a>
                                    </div>
                                </li>
                                <li className="flex items-start gap-6 group">
                                    ...
                                    <div className="flex flex-col pt-1">
                                        ...
                                        <a href="tel:+919047033448" className="font-serif text-[22px] text-brand-gold hover:text-brand-gold-light transition-colors">
                                            +91 90470 33448
                                        </a>
                                    </div>
                                </li>
